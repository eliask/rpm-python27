...
%{!?python27_sitelib: %global python27_sitelib %(python2.7 -c "from distutils.sysconfig import get_python_lib; print get_python_lib()")}
...
%{__sed} -i -e "1s|#!/usr/bin/env python2.7||" virtualenv.py 
...
python2.7 setup.py install --skip-build --root $RPM_BUILD_ROOT
...
%changelog
* Thu Sep 07 2013 Elias Kunnas <elias.kunnas@gmail.com> - 1.10.1-1
- Hacked to support Python 2.7
